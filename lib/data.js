...
export const skillsList = [
  {
    ...
    skills: ["Python", "C++", "Java", "HTML/CSS", "Tailwind CSS", "Javascript", "Typescript", "SQL", "Dart", "Bash"],
  },
  {
    title: "Frameworks",
    skills: ["React", "NextJS", "NodeJS", "Flutter", "Langchain", "Pytorch", "Tensorflow", "Keras", "Selenium"],
  },
  {
    title: "Tools",
    skills: ["Git", "Linux", "AWS", "Docker", "Kubernetes", "OpenCV", "FFmpeg", "Whisper", "ElasticSearch"],
  },
  {
    title: "Firmware",
    skills: ["Arduino", "Raspberry Pi", "STM32CUBE", "FPGA"],
  },
];
...
export const projectsList = [
  ...
  },
  {
    ...
    link: "https://github.com/BrianLi23/sparse-autoencoder",
  },
];
